...
// OpenAPIValidator is a struct to validate the OpenAPI specification
...
func PrepareOpenAPIValidator(openAPIDefPath string) (*OpenAPIValidator, error) {
...
func (v *OpenAPIValidator) ValidateResponse(responseBody []byte, request *http.Request, statusCode int, headers http.Header) error {
