...
// {
// 	desc: "Testing CreateTaskAnsiblePlaybookHandler.Handle responding with an error when request payload is invalid and is returning an StatusBadRequest",
// 	handler: NewCreateTaskAnsiblePlaybookHandler(
// 		service.NewMockAnsiblePlaybookService(),
// 		logger.NewFakeLogger(),
// 	),
...
// 	},
// 	arrangeTestFunc: func(h *CreateTaskAnsiblePlaybookHandler) {
// 		h.service.(*service.MockAnsiblePlaybookService).On("Run", mock.Anything, mock.Anything).Return(errors.New("invalid request payload"))
// 	},
// 	assertTestFunc: func(t *testing.T, rec *httptest.ResponseRecorder) {
// 		var body *response.TaskErrorResponse
// 		expectedBody := &response.TaskErrorResponse{
// 			Error: fmt.Sprintf("%s: %s", ErrInvalidRequestPayload, "invalid request payload"),
// 		}
// 		err := json.Unmarshal(rec.Body.Bytes(), &body)
// 		assert.NoError(t, err)
// 		assert.Equal(t, expectedBody, body)
...
// {
// 	desc: "Testing CreateTaskAnsiblePlaybookHandler.Handle responding with an error when request payload binding fails and is returning an StatusInternalServerError",
// 	handler: NewCreateTaskAnsiblePlaybookHandler(
// 		service.NewMockAnsiblePlaybookService(),
// 		logger.NewFakeLogger(),
// 	),
...
// 	},
// 	arrangeTestFunc: func(h *CreateTaskAnsiblePlaybookHandler) {
// 		// Simulate binding error by providing invalid JSON payload
// 		h.service.(*service.MockAnsiblePlaybookService).On("Run", mock.Anything, mock.Anything).Return(nil)
// 	},
// 	assertTestFunc: func(t *testing.T, rec *httptest.ResponseRecorder) {
// 		var body *response.TaskErrorResponse
// 		expectedBody := &response.TaskErrorResponse{
// 			Error: fmt.Sprintf("%s: %s", ErrBindingRequestPayload, "invalid character 'i' looking for beginning of value"),
// 		}
// 		err := json.Unmarshal(rec.Body.Bytes(), &body)
// 		assert.NoError(t, err)
// 		assert.Equal(t, expectedBody, body)
...
// 	},
// 	arrangeTestFunc: func(h *CreateTaskAnsiblePlaybookHandler) {
// 		// Simulate validation error by providing invalid request parameters
// 		h.service.(*service.MockAnsiblePlaybookService).On("Run", mock.Anything, mock.Anything).Return(nil)
// 	},
// 	assertTestFunc: func(t *testing.T, rec *httptest.ResponseRecorder) {
// 		var body *response.TaskErrorResponse
// 		expectedBody := &response.TaskErrorResponse{
// 			Error: fmt.Sprintf("%s: %s", ErrInvalidRequestPayload, "validation error"),
// 		}
// 		err := json.Unmarshal(rec.Body.Bytes(), &body)
// 		assert.NoError(t, err)
// 		assert.Equal(t, expectedBody, body)
